...
public class Atividade01 {
    public static void main(String[] args) {
        int quant = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade de nomes a ser cadastrada"));
        ...
        while (true) {
            int posicao = Integer.parseInt(JOptionPane.showInputDialog(null, "Informe a posição do nome a ser consultado ou -1 para sair"));
